...
################################################################################
## Form generated from reading UI file 'PyDAQ_get_model_NIDAQ_widgetpEcFvw.ui'
##
...
class Ui_Arduino_GetModel_W(object):
    def setupUi(self, Arduino_GetModel_W):
        ...
        Arduino_GetModel_W.resize(739, 622)
        ...
        self.gridLayout.addWidget(self.widget_4, 6, 2, 1, 1, Qt.AlignmentFlag.AlignLeft)
        ...
        self.gridLayout.addWidget(self.widget_19, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget_10, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget_6, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.widget_8, 4, 2, 1, 1)

        self.widget_2 = QWidget(self.widget)
        self.widget_2.setObjectName("widget_2")
        self.gridLayout_3 = QGridLayout(self.widget_2)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.choose_device_in = QComboBox(self.widget_2)
        self.choose_device_in.setObjectName("choose_device_in")
        self.choose_device_in.setMinimumSize(QSize(0, 22))
        self.choose_device_in.setMaximumSize(QSize(16777215, 22))

        self.gridLayout_3.addWidget(self.choose_device_in, 0, 0, 1, 1)
        ...
        self.choose_channel_in = QComboBox(self.widget_11)
        self.choose_channel_in.setObjectName("choose_channel_in")

        self.gridLayout_9.addWidget(self.choose_channel_in, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.line, 0, 1, 11, 1)
        ...
        self.terminal_config_in = QComboBox(self.widget_12)
        self.terminal_config_in.setObjectName("terminal_config_in")

        self.gridLayout_10.addWidget(self.terminal_config_in, 0, 0, 1, 1)

        self.gridLayout.addWidget(self.widget_12, 2, 2, 1, 1)
    ...
    def retranslateUi(self, Arduino_GetModel_W):
        ...
        self.label_10.setText(
            QCoreApplication.translate("Arduino_GetModel_W", "Choose channel:", None)
        )
        self.label.setText(
